...
import { SchedulerContext } from '@iScheduler/provider/SchedulerContext';
import { EWeekDays, getKeyFromEnum } from '@iScheduler/types';

// Mocks
vi.mock('@iScheduler/handlers', () => ({
  handleDurationValueChange: vi.fn(),
  handleSelectWeeklyDay: vi.fn(),
}));
...
vi.mock('@iScheduler/components/behaviors/WeeklyBehavior', () => ({
