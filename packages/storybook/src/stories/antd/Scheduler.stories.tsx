...
import { SchedulerProvider, ESchedulerPrefix, CScheduler, EDurationTypes, EDiscountType } from '@teamco/ischeduler-core';
import { Scheduler } from '@teamco/ischeduler-antd';
