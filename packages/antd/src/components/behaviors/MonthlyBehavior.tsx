...
import { handleDurationValueChange, handleSelectWeeklyDay } from '@teamco/ischeduler-core';
import { useSchedulerContext } from '@teamco/ischeduler-core';
import { EWeekDays, type TSchedulerRepeat } from '@teamco/ischeduler-core';
import { getKeyFromEnum } from '@teamco/ischeduler-core';
  ...
  const weeks = useCallback(() => {
    ...
    const periods = (
      ...
      return {
        ...
        label: t(labelKey),
        icon:
          currentWeekDay === value ? <CalendarTwoTone /> : <CalendarTwoTone twoToneColor="gray" />,
      };
    });
